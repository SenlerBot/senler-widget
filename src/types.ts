...
export type SenlerWidgetJsonObject = { [key: string]: SenlerWidgetJsonValue };
export type SenlerWidgetLocalizedText = { ru?: string; en?: string };
...
export interface SenlerWidgetContextItem {
  ...
  display: { label: string; subtitle?: string; icon?: string; avatar_url?: string };
...
export interface SenlerWidgetTheme {
  ...
  welcome_buttons?: { ru?: string[]; en?: string[] };
  button?: {
...
export type SenlerWidgetCustomActionDefinition = {
  ...
  | { returnsResult?: false; handler: (detail: SenlerWidgetCustomActionDetail) => void }
...
export type SenlerWidgetPageElementActionPayload = {
  ...
  | { target: SenlerWidgetPageElementActionTarget; target_chain?: undefined }
  | { target?: undefined; target_chain: SenlerWidgetPageElementActionTarget[] }
);
...
export type SenlerWidgetPersistentRuntimeConfig = Pick<SenlerWidgetRuntimeConfig,
  "lang" | "theme_mode" | "border_radius" | "shell" | "customActions" | "customActionsLanguage" | "autoExecuteCustomActionNames" | "pageContextItems"
>;
...
export interface SenlerWidgetInlineTextEditConfig {
  ...
  fieldLabel: string;
  getValue: () => string;
  getSelection?: () => string | { text: string };
  contextItems?: SenlerWidgetContextItem[];
